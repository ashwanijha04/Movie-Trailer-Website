...
import media
#importing fresh_tomatoes module which contains the html code and some functions
...
#Calling the function to open the movie website contained in the fresh_tomatoes module
